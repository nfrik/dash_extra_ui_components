...
''ExtraDashUiComponents <- function(id=NULL, sitekey=NULL, theme=NULL, captchaType=NULL, size=NULL, index=NULL, language=NULL, onResponse=NULL, onExpire=NULL, responsetext=NULL) {
