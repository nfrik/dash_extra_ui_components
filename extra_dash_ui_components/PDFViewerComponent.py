...
- date64 (string; default ''): PDF file encoded in base64
...
- protectContent (boolean; default False): By default Right Click and Context Menu are enabled, but can be disabled by passing this prop"""
    @_explicitize_args
    def __init__(self, url=Component.UNDEFINED, date64=Component.UNDEFINED, page=Component.UNDEFINED, scale=Component.UNDEFINED, scaleStep=Component.UNDEFINED, maxScale=Component.UNDEFINED, minScale=Component.UNDEFINED, css=Component.UNDEFINED, navbarOnTop=Component.UNDEFINED, hideZoom=Component.UNDEFINED, hideRotation=Component.UNDEFINED, protectContent=Component.UNDEFINED, **kwargs):
        self._prop_names = ['url', 'date64', 'page', 'scale', 'scaleStep', 'maxScale', 'minScale', 'css', 'navbarOnTop', 'hideZoom', 'hideRotation', 'protectContent']
        self._type = 'PDFViewerComponent'
        self._namespace = 'extra_dash_ui_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['url', 'date64', 'page', 'scale', 'scaleStep', 'maxScale', 'minScale', 'css', 'navbarOnTop', 'hideZoom', 'hideRotation', 'protectContent']
