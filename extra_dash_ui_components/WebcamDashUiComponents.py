...
- screenshotWidth (number; default 640): width of screenshot
- screenshotHeight (number; default 480): width of screenshot
...
getScreenshot(). It is currently capped at 25 fps."""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, className=Component.UNDEFINED, audio=Component.UNDEFINED, height=Component.UNDEFINED, width=Component.UNDEFINED, screenshotWidth=Component.UNDEFINED, screenshotHeight=Component.UNDEFINED, screenshotFormat=Component.UNDEFINED, screenshotQuality=Component.UNDEFINED, screenshotInterval=Component.UNDEFINED, screenshot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'className', 'audio', 'height', 'width', 'screenshotWidth', 'screenshotHeight', 'screenshotFormat', 'screenshotQuality', 'screenshotInterval', 'screenshot']
        self._type = 'WebcamDashUiComponents'
        self._namespace = 'extra_dash_ui_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'audio', 'height', 'width', 'screenshotWidth', 'screenshotHeight', 'screenshotFormat', 'screenshotQuality', 'screenshotInterval', 'screenshot']
