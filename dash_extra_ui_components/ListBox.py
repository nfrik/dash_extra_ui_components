...
- metaKeySelection (boolean; default False): Defines how multiple items can be selected,
...
- tabIndex (string; default '0'): Index of the element in tabbing order.
...
- disabled (boolean; optional): When specified, disables the component.
